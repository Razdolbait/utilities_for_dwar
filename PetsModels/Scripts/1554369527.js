...
function luckyMsg(text, url) {
	...
	showMsg2("error.php?error=" + encodeURIComponent(text), "РЎРѕРѕР±С‰РµРЅРёРµ");
...
function artifactAlt(obj, evnt, show) {
	// РЎРѕСЂС‚РёСЂРѕРІРєР° РІ СЂСЋРєР·Р°РєРµ
	if (typeof (iam_sorting_now) !== 'undefined' && iam_sorting_now) {
		show = 0;
	}
	...
	if (act2 === null) act2 = 0;
	if (act3 == 0 || act3 === null) act3 = '' // РєРѕСЃС‚С‹Р»СЊ С‡С‚Рѕ Р±С‹ РЅРµ РїРµСЂРµРёРјРµРЅРѕРІС‹РІР°С‚СЊ РєР°СЂС‚РёРЅРєРё РІ Р»РѕРєР°Р»РёР·Р°С†РёСЏС…
	if (act4 == 0) act4 = '';
	if (act1 == null) act1 = 0;
	if (show == 2) {
...
// РџСЂРёРјРµРЅРёС‚РµР»СЊРЅРѕ Рє РѕР±СЉРµРєС‚Р°Рј Array
// IE СЃС†СѓРєРѕ РЅРµ РїРѕРґРґРµСЂР¶РёРІР°РµС‚ Array::indexOf
			...
			<tr style=\"height: 33px;\">\
		  	...
		  	<tr height=\"100%\">\
				...
				<td class=\"bgg\" align=\"center\" valign=\"middle\">\
					<b>Р”РѕСЃС‚СѓРїРЅС‹Рµ РјР°РіР°Р·РёРЅС‹</b>\
					<br><br>\
					...
					<b class=\"butt1 pointer\"><b><input value=\"РћС‚РјРµРЅР°\" type=\"button\" onclick=\"confirmCenterDivClose();\" class=\"redd\"></b></b>\
				</td>\
...
function systemConfirm(title, ms, obj, func) {
	...
	if (title) {
		...
		var confirm_title = gebi('confirm_title');
		confirm_title.innerHTML = 'РЎРѕРѕР±С‰РµРЅРёРµ';
	}
	if (ms) {
...
/**
 * РѕР±РЅРѕРІРёС‚СЊ С‚РµРєСѓС‰РµРµ РѕС‚РєСЂС‹С‚РѕРµ Р·РґР°РЅРёРµ РІ РїРѕРјРµСЃС‚СЊРµ
 *
 * @return void
 */
...
/**
* Р¤СѓРЅРєС†РёСЏ РїСЂРѕРІРµСЂСЏРµС‚ СЃРєРѕР»СЊРєРѕ СЃРёРјРІРѕР»РѕРІ РѕСЃС‚Р°Р»РѕСЃСЊ РІРІРµСЃС‚Рё РїРѕР»СЊР·РѕРІР°С‚РµР»СЋ
* (РґР»СЏ РїРѕР»РµР№ СЃ РѕРіСЂР°РЅРёС‡РµРЅРёРµРј РїРѕ РєРѕР»РёС‡РµСЃС‚РІСѓ СЃРёРјРІРѕР»РѕРІ)
*
* @param object        - РѕР±СЉРµРєС‚ Event
* @param string|object - ID РЅСѓР¶РЅРѕРіРѕ РїРѕР»СЏ РёР»Рё РµРіРѕ DOM-РЅРѕРґР°
* @param string|object - ID Р±Р»РѕРєР° СЃ РёРЅС„РѕСЂРјР°С†РёРµР№ Рѕ РєРѕР»РёС‡РµСЃС‚РІРµ СЃРёРјРІРѕР»РѕРІ РёР»Рё РµРіРѕ DOM-РЅРѕРґР°
* @param string        - С‚РµРєСЃС‚ РґР»СЏ РїРѕР»СЏ СЃ РёРЅС„РѕСЂРјР°С†РёРµР№ СЃ СЂР°Р·РґРµР»РёС‚РµР»СЏРјРё "|" РґР»СЏ СЂР°Р·Р±РёРІРєРё РІ РјР°СЃСЃРёРІ
*
* @return void
*/
function countSymbols(e, field, infoBlock, infoLabel) {
	...
	if (key > 36 && key < 41) { // РЅРµ РѕР±СЂР°Р±Р°С‚С‹РІР°РµРј СЃС‚СЂРµР»РєРё
		return;
	}

	if (e.ctrlKey || e.altKey || e.metaKey) { // РЅРµ РѕР±СЂР°Р±Р°С‚С‹РІР°РµРј СЃРїРµС†. СЃРёРјРІРѕР»С‹
		return;
	}
	...
	if (field.getAttribute('maxlength')) {
		// РџРѕР·РёС†РёСЏ РєР°СЂРµС‚РєРё РґРѕ РІСЃС‚Р°РІРєРё С‚РµРєСЃС‚Р° СЃРєСЂРёРїС‚РѕРј
		var caretPos = getCaretPosition(field);

		/*
		* РЅР° РјРѕРјРµРЅС‚ СЃСЂР°Р±Р°С‚С‹РІР°РЅРёСЏ keydown СЃРёРјРІРѕР» РµС‰Рµ РЅРµ РІРІРµРґРµРЅ РІ РїРѕР»Рµ
		* С‡С‚РѕР±С‹ РѕР±РѕР№С‚Рё СЌС‚Рѕ РёСЃРїРѕР»СЊР·СѓРµРј РєРѕСЃС‚С‹Р»СЊ РІ РІРёРґРµ setTimeout СЃ РЅСѓР»РµРІС‹Рј РёРЅС‚РµСЂРІР°Р»РѕРј
		*/
		setTimeout(function () {
...
/**
* Р¤СѓРЅРєС†РёСЏ РїРѕР»СѓС‡Р°РµС‚ РїРѕР·РёС†РёСЋ РєР°СЂРµС‚РєРё РІ input РёР»Рё textarea
*
* @param object - DOM-РЅРѕРґР° РїРѕР»СЏ
*
* @return number
*/
...
/**
* Р¤СѓРЅРєС†РёСЏ СѓСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ РїРѕР·РёС†РёСЋ РєР°СЂРµС‚РєРё РІ input РёР»Рё textarea
*
* @param object - DOM-РЅРѕРґР° РїРѕР»СЏ
* @param number - РїРѕР·РёС†РёСЏ РєР°СЂРµС‚РєРё
*
* @return void
*/
...
/**
* РђРЅР°Р»РѕРі С„СѓРЅРєС†РёРё html_period_str, СЂРµР°Р»РёР·РѕРІР°РЅРЅРѕР№ РЅР° PHP
*
* @param {number} - РІСЂРµРјСЏ РІ СЃРµРєСѓРЅРґР°С…
* @param {array} - РјР°СЃСЃРёРІ СЃ РїРѕРґРїРёСЃСЏРјРё Рє С‡Р°СЃР°Рј, РјРёРЅСѓС‚Р°Рј, СЃРµРєСѓРЅРґР°Рј Рё С‚.Рї.
*                  ['Рґ', 'С‡', 'РјРёРЅ', 'СЃРµРє']
* @param {boolean} - РїРѕРєР°Р·С‹РІР°С‚СЊ/РЅРµ РїРѕРєР°Р·С‹РІР°С‚СЊ СЃРµРєСѓРЅРґС‹
* @param {boolean} - РїРѕРєР°Р·С‹РІР°С‚СЊ/РЅРµ РїРѕРєР°Р·С‹РІР°С‚СЊ РјРёРЅСѓС‚С‹
* @param {string} - СЂР°Р·РґРµР»РёС‚РµР»СЊ
* @param {boolean} - РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ Р»Рё СЂР°СЃС€РёСЂРµРЅС‹Р№ СЂРµР¶РёРј
*
* @return {string}
*/
...
/**
* РќР°Р№С‚Рё Р±Р»РёР¶Р°Р№С€РµРіРѕ СЂРѕРґРёС‚РµР»СЏ СЃ Р·Р°РґР°РЅРЅС‹Рј ID РёР»Рё className
*
* @param {object} - DOM-РЅРѕРґР° РёР»Рё РµС‘ ID, РЅР°С‡РёРЅР°СЏ СЃ РєРѕС‚РѕСЂРѕР№ Р±СѓРґРµРј РїРѕРґРЅРёРјР°С‚СЊСЃСЏ РІРІРµСЂС… РїРѕ РґРµСЂРµРІСѓ
* @param {string} - id РёР»Рё class Сѓ СЂРѕРґРёС‚РµР»СЏ, РєРѕС‚РѕСЂС‹Р№ РёС‰РµРј
*
* @return {boolean|object} - РѕР±СЉРµРєС‚ РІ СЃР»СѓС‡Р°Рµ СѓСЃРїРµС€РЅРѕРіРѕ РїРѕРёСЃРєР° Рё false РІ СЃР»СѓС‡Р°Рµ РїСЂРѕРІР°Р»Р°
*/
...
/**
* Р¤СѓРЅРєС†РёСЏ РѕР±СЂР°С‚РЅРѕРіРѕ РѕС‚СЃС‡РµС‚Р° РѕСЃС‚Р°РІС€РµРіРѕСЃСЏ РІСЂРµРјРµРЅРё
*
* @param {object|string} - DOM-РЅРѕРґР° РёР»Рё РµС‘ ID
* @param {number} - РІСЂРµРјСЏ РґРѕ РёСЃС‚РµС‡РµРЅРёСЏ СЃСЂРѕРєР°
* @param {array} - РјР°СЃСЃРёРІ СЃ РїРѕРґРїРёСЃСЏРјРё Рє С‡Р°СЃР°Рј, РјРёРЅСѓС‚Р°Рј, СЃРµРєСѓРЅРґР°Рј Рё С‚.Рї.
*                  ['Рґ', 'С‡', 'РјРёРЅ', 'СЃРµРє']
* @param {function} - РєРѕР»Р»Р±СЌРє
*
* @return {void}
*/
...
if (window.$) {
	$(document).on('click', 'span.artifact-slot', function (evnt) {
		...
		var constants = win._top().dwar || {};
		// РёР·РјРµРЅРёС‚СЊ РґРµР№СЃС‚РІРёРµ
...
function html_money_str(count, price, price_gold, price_work, price_silver, hide_empty_silver) {
	...
	//СЂР°Р±РѕС‚Р°РµРј СЃ int С‡С‚РѕР±С‹ РёР·Р±РµР¶Р°С‚СЊ РїСЂРѕР±Р»РµРј С‚РёРїР° 101.1-101 = 0.09999999999999432
	...
	switch (action) {
		...
		case "breakopen":
			entry_point_request('puzzlechest', action, { steps: steps }, function (data) {
				if (data && data["error"]) {
					showMsg2("error.php?error=" + encodeURIComponent(data["error"]), "РЎРѕРѕР±С‰РµРЅРёРµ");
				} else {
					confirmCenterDivClose();
				}
			});
...
/**
* Р¤СѓРЅРєС†РёСЏ РґРµР»Р°РµС‚ РѕР±СЉРµРєС‚ Event РєСЂРѕСЃСЃР±СЂР°СѓР·РµСЂРЅС‹Рј
*
* @param object - РѕР±СЉРµРєС‚ С‚РёРїР° Event
* @param object - РєРѕРЅС‚РµРєСЃС‚ currentTarget
*
* @return void
*/
...
/**
* Р¤СѓРЅРєС†РёСЏ РїРѕР»СѓС‡Р°РµС‚ СЃРґРІРёРі СЌР»РµРјРµРЅС‚Р°, РєРѕС‚РѕСЂС‹Р№ СЂР°СЃРїРѕР»РѕР¶РµРЅ РІРѕ
* С„СЂРµР№РјРµ, РѕС‚РЅРѕСЃРёС‚РµР»СЊРЅРѕ РѕР±Р»Р°СЃС‚Рё РїСЂРѕСЃРјРѕС‚СЂР° (Р±РµР· СѓС‡С‘С‚Р° СЃРєСЂРѕР»Р»Р°)
*
* @return object
*/
...
function initBirthdayWindow(useCanvas) {
	...
	if (lastUserId > 0) {
		...
		// РїРѕСЃРµ Р·Р°РіСЂСѓР·РєРё РѕРєРЅР°, СЃР±СЂРѕСЃРёРј РїРѕСЃР»РµРґРЅРµРіРѕ РІС‹Р±СЂР°РЅРЅРѕРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ
